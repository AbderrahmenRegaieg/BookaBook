...
namespace WebAppcore.Migrations
{
    ...
    [Migration("20250616085919_ModifTabl")]
    partial class ModifTabl
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("WebAppcore.Models.Product", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Reference = "Pc55",
                            CategoryId = 2,
                            Path = "C:/Users/regai/Downloads/richman book.jpg",
                            Prix = 5000f,
                            Qte = 26
                        });
                });
            ...
            modelBuilder.Entity("WebAppcore.Models.Register", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            DateNaissance = new DateTime(2025, 6, 16, 0, 0, 0, 0, DateTimeKind.Local),
